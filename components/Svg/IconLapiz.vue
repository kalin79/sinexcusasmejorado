<template>
    <div class="boxLapiz">
        <svg version="1.1" id="svgLapiz" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 50 45" style="enable-background:new 0 0 50 45;" xml:space="preserve">
        <path class="svgLapiz" d="M42.7,5.9l-1-1c-0.9-0.9-2.2-1.4-3.5-1.4c-1.3,0-2.5,0.5-3.5,1.4L8.6,30.9c-0.3,0.3-0.6,0.8-0.8,1.2L6,37.5
